...
tcol1.image(Image.open('D:/OneDrive - Deakin University/abbas web app project/project 2 - fire fighter/icon/Icons/Icons 1/fire_icon.png'),width=70)
tcol2.markdown("<h2 style='text-align: center; color: white;'>AAR Webapp</h2>", unsafe_allow_html=True)
tcol3.image(Image.open('D:/OneDrive - Deakin University/abbas web app project/project 2 - fire fighter/icon/Icons/Icons 1/IISRI_logo.png'),width=150)
...
if check_password():
    ...
    with tab1:
        ...
        file = "D:/OneDrive - Deakin University/abbas web app project/project 2 - fire fighter/data/data_all_collectionData_211116_data_analysisDate_211118.csv"
        df = pd.read_csv(file)
        ...
        for i in range(3):
            ...
            icon_src = Image.open(f"D:/OneDrive - Deakin University/abbas web app project/project 2 - fire fighter/icon/Icons/Icons 1/{img_val[i]}")
             ##  
        ...
        icon_src2 = Image.open("D:/OneDrive - Deakin University/abbas web app project/project 2 - fire fighter/icon/Icons/Icons 1/AC_Report.png")
        ...
        # row=1,
        # col=col + 1,
        source=Image.open(icon_path+"fire_icon.png"),
        xref="paper",
        yref="paper",
        x=0.,
        y=1.7,
        ...
        for i in range(5):
            plot.add_layout_image(dict(
                # row=1,
                # col=col + 1,
                source=Image.open(icon_path+f'{i+1}.png'),
                xref="paper",
                yref="paper",
                x=(i+1)*0.2,
                y=1.7,
        ...
        icon_src2 = Image.open("D:/OneDrive - Deakin University/abbas web app project/project 2 - fire fighter/icon/Icons/Icons 1/water_icon.png")
        fig.add_layout_image(dict(
        # row=1,
        # col=col + 1,
        source=icon_src2,
    ...
    with tab2:
        ...
        if subject_select != []:
            ...
            for i in range(3):
                ...
                source=Image.open("D:/OneDrive - Deakin University/abbas web app project/project 2 - fire fighter/icon/Icons/Icons 1/firefighter_Report.png")
    ...
    with tab4:
        ...
        dff.to_csv(file_group+'/session_1.csv')
        dff = dff/dff.max()
        ...
        with tab5:
            ...
            for i in range(5):
                df2=pd.read_csv(file_group+f'/session_{i+1}.csv',index_col='subject')
